...
class VideoFilterTest extends TestCase {
	...
	public function testVideoSpecificTags() {
		...
		$this->assertEquals('<embed src="//mediaservices.myspace.com/services/media/embed.aspx/m=c0dE,t=1,mt=video" width="525" height="420" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true"></embed>', $this->object->reset('[myspace size="large"]c0dE[/myspace]')->parse());
		$this->assertEquals('<embed src="//wegame.com/static/flash/player.swf?xmlrequest=http://www.wegame.com/player/video/c0dE&amp;embedPlayer=true" width="480" height="330" type="application/x-shockwave-flash" allowscriptaccess="always" allowfullscreen="true"></embed>', $this->object->reset('[wegame size="medium"]c0dE[/wegame]')->parse());
