...
class TableFilterTest extends TestCase {
    ...
    public function testTh() {
        ...
        $this->assertEquals('<table class="decoda-table"><tr><th colspan="3">Three</th></tr></table>', $this->object->reset('[table][tr][th colspan="3"]Three[/th][/tr][/table]')->parse());
        $this->assertEquals('<table class="decoda-table"><tr><th colspan="3" rowspan="4">Four</th></tr></table>', $this->object->reset('[table][tr][th colspan="3" rowspan="4"]Four[/th][/tr][/table]')->parse());
        $this->assertEquals('<table class="decoda-table"><tr><th rowspan="5">Five</th></tr></table>', $this->object->reset('[table][tr][th rowspan="5"]Five[/th][/tr][/table]')->parse());
